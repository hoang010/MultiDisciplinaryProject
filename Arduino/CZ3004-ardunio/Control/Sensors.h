...
SharpIR SR1(SharpIR::GP2Y0A21YK0F_rightFront, A0); //front right
...
SharpIR LR5(SharpIR::GP2Y0A02YK0F, A4); //looking left
SharpIR SR6(SharpIR::GP2Y0A21YK0F, A5); //front center
