...
#define M1k  0.344551284
#define M1ts  0.0078 //78,0.00565
#define M1td  0.1 //12//066//0.047;//0.07625;

#define M2k  0.357663857
#define M2ts  0.009//36 //77;
#define M2td  0.07//116 // 0.8 //Less turn right, more urn left
