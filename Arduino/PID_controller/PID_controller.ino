...
#define M1k  0.37385768
#define M1ts  0.0078//78,0.00565,895
#define M1td  0.07//12//066//0.047;//0.07625;

#define M2k  0.361276728
#define M2ts  0.0077//36 //77;
#define M2td  0.1//116 // 0.8 //Less turn right, more urn left
